...
function MoviePage() {
  ...
  let count = 0;
  useEffect(() => {
    fetchData('https://api.themoviedb.org/3/trending/tv/day');
  }, []);
  ...
  const AiringToday = () =>
    fetchData('https://api.themoviedb.org/3/tv/airing_today');
  const OnTheAir = () => fetchData('https://api.themoviedb.org/3/tv/on_the_air');
  const Popular = () =>
    fetchData('https://api.themoviedb.org/3/tv/popular');
  const TopRated = () =>
    fetchData('https://api.themoviedb.org/3/tv/top_rated');
  const Discover = () =>
    fetchData('https://api.themoviedb.org/3/discover/tv');
